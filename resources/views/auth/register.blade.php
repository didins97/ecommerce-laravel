...
<body>
              ...
              <div class="card-body">
                <form method="POST" method="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="last_name" type="text" class="form-control @error('name') is-invalid @enderror" name="name">
                      </div>
  ...
  <!-- JS Libraies -->
  <script src="{{ asset('backend') }}/node_modules/jquery-pwstrength/jquery.pwstrength.min.js"></script>
