...
<div class="card">
    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="form-product">
        @csrf @method('PATCH')
        <div class="card-body">
            <div class="form-row">
                <div class="col-7">
                    <div class="form-message">
                        ...
                        <input type="text" class="form-control" name="product_name" placeholder="Masukan Nama Produk"
                ...
                <div class="col">
                  <div class="form-check mb-3">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline1" name="type" value="new" class="custom-control-input"
                            checked>
...
<script>
    let parent_value = $('#parent_cat').val();
    if (parent_value != '') {
        requestSubCategory(parent_value);
    }
    ...
    function requestSubCategory(id) {
        $.ajax({
