    ...
    <div class="card-body">
        <form action="{{ route('promotion.update', $promotion->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-check mb-3">
                ...
                <input type="checkbox" name='is_active' id='is_active' value='1' @if ($promotion->is_active == 1)
                checked @endif> Ya
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Timer</label>
                <input type="text" name="time_limit" value="{{ $promotion->time_limit }}"
